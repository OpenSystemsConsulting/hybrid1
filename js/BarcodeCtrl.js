...
.controller('BarcodeCtrl', [ '$rootScope', '$scope', '$cordovaBarcodeScanner', 'cordovaReady', 'Logger', 'pdaParams', '$ionicPopup','BarcodeHist','LocalBarcodeHist','barcode_sync', 'Job', '$cordovaDevice','barcodeService','siteConfig',
	function ($rootScope, $scope, $cordovaBarcodeScanner, cordovaReady, Logger, pdaParams,$ionicPopup,BarcodeHist,LocalBarcodeHist,barcode_sync, Job, $cordovaDevice, barcodeService,siteConfig ) {
