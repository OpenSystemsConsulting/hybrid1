...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__device__ = __webpack_require__(861);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_launch_navigator__ = __webpack_require__(209);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_exit_service_exit_service__ = __webpack_require__(463);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_push_service_push_service__ = __webpack_require__(464);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_navigation_service_navigation_service__ = __webpack_require__(465);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__providers_log_service_log_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__app_app_component__ = __webpack_require__(466);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DevicePage = /** @class */ (function () {
    function DevicePage(navCtrl, navParams, platformReady, configService, logger, pdaParams, gpsService, exitService, deviceService, sharedService, storage, alertCtrl, siteConfig, messageService, jobService, jseaService, sodService, conMonService, pushService, navigatorService, navigatorPlugin, app, platform) {
        ...
        this.toggleSyncInProgress = function () {
            _this.sharedService.setSyncInProgress(!_this.sharedService.getSyncInProgress());
        };
        ...
        this.signatureThrottleChanged = function (newvalue) {
            localStorage.setItem('signatureThrottle', newvalue);
        };
        ...
        this.def_signature_throttle = this.siteConfig.getSiteConfigInt('PDA_SIGNATURE_THROTTLE') || 16;
        this.sync_in_progress = this.sharedService.getSyncInProgress();
    } //Constructor ends
