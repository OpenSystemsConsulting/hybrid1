...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login__ = __webpack_require__(869);
...
var LoginPage = /** @class */ (function () {
            ...
            if (_this.allowed) {
                ...
                (function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.storage.set('login', JSON.stringify(loginDetails))];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.storage.set('userId', this.registerCredentials.username)];
                            case 2:
                                _a.sent();
    ...
    LoginPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_3__providers_login_service_login_service__["a" /* LoginServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
