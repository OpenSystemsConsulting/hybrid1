...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_log_service_log_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_pdaparams_service_pdaparams_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_shared_service_shared_service__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_app_component__ = __webpack_require__(464);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PdaPage = /** @class */ (function () {
    function PdaPage(navCtrl, navParams, configService, pdaParams, logger, sharedService, TpmPdaController, alertCtrl, iab, app, platform, device) {
        var _this = this;
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                localStorage.clear();
                                _this.app.getRootNav().setRoot(__WEBPACK_IMPORTED_MODULE_10__app_app_component__["a" /* MyApp */]);
                            }
                        },
                        {
                            text: 'Cancel',
